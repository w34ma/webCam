...
public class VHMsg implements javax.jms.MessageListener
{
    ...
    private Vector< edu.usc.ict.vhmsg.MessageListener > m_iConsumers = new Vector< edu.usc.ict.vhmsg.MessageListener >();
    ...
    public static final String VHMSG_PORT = "61616";
    ...
    public void addMessageListener( edu.usc.ict.vhmsg.MessageListener pol )
    {
        m_iConsumers.addElement( pol );
    }


    public void removeMessageListener( edu.usc.ict.vhmsg.MessageListener pol )
    {
    ...
    public int poll()
    {
        ...
        if ( !m_immediateMethod )
        {
            for ( ;; )
            {
                ...
                for ( edu.usc.ict.vhmsg.MessageListener m_iConsumer : m_iConsumers )
                {
    ...
    {
        String server = System.getProperty( VHMSG_SERVER );
        if ( server == null )
            server = "localhost";
    ...
    {
        String port = System.getProperty( VHMSG_PORT );
        if ( port == null )
            port = "61616";
    ...
    {
        String scope = System.getProperty( VHMSG_SCOPE );
        if ( scope == null )
            scope = "DEFAULT_SCOPE";
